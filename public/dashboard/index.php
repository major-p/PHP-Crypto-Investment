...
if(isset($_POST['submit']))
{
    ...
    $ret = "SELECT * FROM `users` WHERE `email`='$email' AND `password`='$password'";
    ...
    $log="INSERT INTO userslog(uid,username,userip,status) values('".$_SESSION['id']."','".$_SESSION['email']."','$uip','$status')";
        ...
        <div class="row w-100 m-0">
          ...
          <div class="logo-container">
            ...
            <div class="login-text-wrapper">
                <h3 class="card-title text-left mb-3 black-font">Sign in</h3>
            </div>
