...
?>
<!-- inner hero start -->
<section class="inner-hero bg_img" data-background="assets/images/bg/5.jpg">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
    ...
    <section class="pt-120 pb-120">
      <div class="container">
        <div class="contact-wrapper">
          <div class="row">
            <div class="col-lg-6 contact-thumb bg_img" data-background="assets/images/bg/3.jpg"></div>
            ...
            <div class="row mb-none-30">
              <div class="col-md-4 col-sm-6 mb-30">
                <div class="contact-item">
                  ...
                  <div class="mt-4">
                    <p><a href="tel:5454458">+46 72 762 73 82</a></p>
                  </div>
              ...
              <div class="col-md-4 col-sm-6 mb-30">
                <div class="contact-item">
                  ...
                  <div class="mt-4">
                    <p><a href="#">info@cryptoeliteinvest.online</span></a></p>
                    <p><a href="#">admin@cryptoeliteinvest.online</span></a></p>
                  </div>
                </div><!-- contact-item end -->
              </div>
              <div class="col-md-4 col-sm-6 mb-30">
                <div class="contact-item">
                  ...
                  <div class="mt-4">
                    <p>Svenska institutet Virkesvägen 2 120 30 Stockholm </p>
                  </div>
                </div><!-- contact-item end -->
              </div>
            </div>
